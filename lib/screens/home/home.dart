                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              CreateProfile(pageState: 'update'),
                        ),
                      );
                      // Navigator.pushNamed(context, '/profile',
                      //     arguments: {'user_type': '', 'state': 'update'});
                      // Navigator.pushNamed(context, '/profile');
                    },
                    child: Text(
                      'BioData Info',
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              CareerDetails(pageState: 'update'),
                        ),
                      );
                    },
                    child: Text(
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              AdditionalInfo(pageState: 'update'),
                        ),
                      );
                    },
                    child: Text(
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => AddFriend(currentUserId: myId),
                        ),
                      );
                    },
                    child: Text(
